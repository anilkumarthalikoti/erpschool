...
<input class="hide" value="<%=reloadActionName%>" name="preaction" id="preaction" reload="<%=reloadVarible%>"/>
	...
	<div class="left">
		...
		<div class="linkBody">
			...
			<div>
				<ul>
				<li url="dashboard.action">MY DASHBOARD </li>
					<li url="addreminder.action">REMINDERS</li>
					<li url="addannouncement.action">ANNOUCEMENT</li>
			...
			<div>
				<ul>
				<li url="userweb.action">CREATE USER </li>
					<li url="rolescreation.action">ROLE CREATION </li>
					<li url="addannouncement.action">ANNOUCEMENT</li>
			...
			<div>
				<ul>
					...
					<li url="admAcceptReject.action">ACCEPT/REJECT APPLICATION</li>
